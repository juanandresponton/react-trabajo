...
export const Cart = () => {
    ...
    return (
        <Box>
            <TextCenter weight="600" size="2rem" marginT="4rem" marginB="4rem">Shopping Cart Status:</TextCenter>
            {cart.cartItems.length === 0 ? (
                <TextCenter size="1.2rem">It's empty! </TextCenter>
            ) : (
                <Container fixed>
                                            ...
                                            <Grid container spacing={2} key={cartItem.id} sx={{ my: 2 }} className="GERAL">
                                                ...
                                                <Grid item xs={4} sm container className='DOIS' >
                                                    ...
                                                    <Grid item display="flex" flexDirection="column" alignItems="flex-end" className='PRECO'>
                                                        <Span>
                                                            USD$ {cartItem.price * cartItem.cartQuantity}
                                                        </Span>
                                                        <Typography variant="caption" component="div">
                                                            USD${cartItem.price} x {cartItem.cartQuantity}
                                                        </Typography>
                                                    </Grid>
                                                </Grid>
                                            </Grid>
